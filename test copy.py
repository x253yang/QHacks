...
def trainForestModel(train_data_features):
    ...
    forest = forest.fit( train_data_features, train["score"] )
...
def main():
    ...
    forest = trainForestModel(train_data_features)

    # Read the test data
    test = pd.read_csv("backup2.csv")
